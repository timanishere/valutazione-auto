...
for i in range(53, number_of_make_and_model):
         ...
         if total_cars > 0:
            ...
            for p in range(1, last_page):
               ...
               for advert_container in advert_containers_arr:
                  ...
                  cursor.execute(f"SELECT make_and_model_id FROM audi_make_and_model_tbl  WHERE make = '{car_make}' AND model = '{car_model}'")
                  ...
                  insert_script = 'INSERT INTO audi_car_prices_tbl (make_and_model_id, year_id, colour_id, gear_id, fuel_type_id, km, kw, price) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)'
