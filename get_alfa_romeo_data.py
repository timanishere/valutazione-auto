...
cursor.execute('SELECT make,model,autoscout_url_make, autoscout_url_model FROM alfa_romeo_make_and_model_tbl')
...
for i in range(33, number_of_make_and_model):
         ...
         if total_cars > 0:
            ...
            for p in range(1, last_page):
               ...
               for advert_container in advert_containers_arr:
                  ...
                  cursor.execute(f"SELECT make_and_model_id FROM alfa_romeo_make_and_model_tbl  WHERE make = '{car_make}' AND model = '{car_model}'")
                  ...
                  insert_script = 'INSERT INTO alfa_romeo_car_prices_tbl (make_and_model_id, year_id, colour_id, gear_id, fuel_type_id, km, kw, price) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)'
